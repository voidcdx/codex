...
- [ ] Implement Weapon Arcanes (Deadhead, Merciless, Cascadia Flare) — stack-based bonuses in engine
...
- [x] Add Warframe buff support — Roar, Eclipse, Xata's Whisper, Nourish *(done: 4 presets with ability strength scaling)*
