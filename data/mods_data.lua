...
return {
	...
	Mods = {
		...
		["Sentient Incision"] = {
			...
			Icon = "SentientIncision.jpg",
			Image = "SentientIncisionMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Melee/Event/Nightwave/NightwaveVenatoAugmentMod",
			Introduced = "42.0.6",
			Link = "Sentient Incision",
			MaxRank = 5,
		...
		["Truth's Flame"] = {
			BaseDrain = 6,
			CodexSecret = false,
			Description = "Enables Tennokai.\r\nTennokai kills grant an additional 4s Tennokai opportunity with +120% Melee Damage bonus.\r\n\r\nCURSE: Suffer 100 <DT_FIRE_COLOR>Heat Damage/s for 6s.\r\n\r\n+1 'Truth'",
			Icon = "Truth'sFlame.jpg",
			Image = "Truth'sFlameMod.png",
			InternalName = "/Lotus/Upgrades/EmpoweredHeavyMelee/CursedSyndicateEmpoweredHeavyMeleeMod",
			Introduced = "42",
			IsExilus = true,
			Link = "Truth's Flame",
			MaxRank = 3,
		...
		["Velox Conclusion"] = {
			...
			Icon = "VeloxConclusion.jpg",
			Image = "VeloxConclusionMod.png",
			InternalName = "/Lotus/Upgrades/Mods/Pistol/Event/Nightwave/NightwaveVeloxAugmentMod",
			Introduced = "42.0.6",
			Link = "Velox Conclusion",
			MaxRank = 5,
